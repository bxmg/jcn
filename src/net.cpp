...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "jcn " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"jcn.net", "seed.jcn.net"},
    {"jcn.net", "seed2.jcn.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"jcn.net", "testnet-seed.jcn.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. jcn is probably already running."), addrBind.ToString().c_str());
        else
