...
uint256 hashGenesisBlock("0x000008e3bcda934d11a6a3aeec2096fe188544af3858317c292c702c1a26b43d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // jcn: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "jcn Signed Message:\n";
...
{
    // jcn: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 24 * 60 * 60; // jcn: 1 day
static const int64 nTargetSpacing = 42; // jcn: 1 minute
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // jcn: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 42; // jcn: 1 minute
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // jcn: 1 day
...
{
    // jcn: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000d48ea6504fa7bfc7fc56eb81193099c34fbd0655d7b9313df6fcbfcf5ea");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
        ...
        block.nVersion = 1;
        block.nTime    = 1483599973;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1433020;

        if (fTestNet)
        {
            block.nTime    = 1483598012;
            block.nNonce   = 2809769;
        }
 ...
 if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xd016890960d6090320e0dc7460427bd2d22e2e7d387a2ad84ee81820b82163dc"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // jcn: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("jcnMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("jcnMiner : ProcessBlock, block not accepted");
    }
